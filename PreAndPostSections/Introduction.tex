...
The proposed cache integrates \gls{reduction} support and organizes its memory into multiple regions optimized for denser and sparser data regions.
...
To further investigate its performance, we complement this analysis with a probabilistic model, that enables rapid simulation and sizing parameters exploration depending on matrices structure (Chapter~\ref{cha:theory}).
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Investigation of optimization techniques to enhance usability and practical deployment.
    \end{itemize}
\end{enumerate}
