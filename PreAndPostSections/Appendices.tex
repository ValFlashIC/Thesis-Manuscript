...
In parallel, the \textit{Benchmarks} repository was developed for efficient benchmarking and performance evaluation, contributed by student Jules DUBOIS during an internship (ORCID: 0009-0006-3165-3372).

Throughout the project, several publications were produced: a state-of-the-art survey~\ref{publ:SoA}, initial \acrlong{spdc} results~\ref{publ:SpDC}, a patent covering the development concepts around \acrlong{spdc}, a paper on the \acrshort{rtl} implementation and analytical model (currently under resubmission), and this manuscript.
...
\begin{itemize}
    ...
    \item \textit{SpDCache RTL}: 5,808 lines (33,696 $\to$ 39,504 total);
    \item \textit{CVA6 RTL}: 255 lines (36,623 $\to$ 36,878 total);
    \item \textit{RTL Platform}: 56 lines (6,156 $\to$ 6,212 total);
    \item \textit{Software}: 1,554 lines;
    \item \textit{Benchmarks}: 7,642 lines.
\end{itemize}
