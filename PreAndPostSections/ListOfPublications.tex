...
\begin{enumerate}[label=\Roman*, ref=\Roman*, itemsep=0.5cm, topsep=0.5cm]
    ...
    %
    \item \label{publ:patent}
        Valentin Isaac-{-}Chassande, Adrian Evans, and Yves Durand. 2025. Dispositif de calcul informatique à mémoire cache optimisée pour le calcul matriciel. \textit{Commissariat à l'Energie Atomique et aux Energies Alternatives}, N° EP4650972, FR3162293 (Nov. 2025).
        References~\cite{Isaac2025_PatentV1} and~\cite{Isaac2025_PatentV2}
    %
\end{enumerate}

\bigskip \bigskip \bigskip

\noindent The papers and patent will be referred to in the thesis using their Roman numerals.
