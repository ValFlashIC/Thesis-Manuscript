...
\begin{highlight}{Definition}{LimeGreen}
    A \textbf{\gls{redC}} is a data-cache containing an arithmetic unit and a dedicated support for \gls{reduction} operations, via single ``fire-and-forget'' \acrshort{red} instructions.
\end{highlight}
