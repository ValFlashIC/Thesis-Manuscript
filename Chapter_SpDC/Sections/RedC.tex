...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.506493506\linewidth} %39/77 (39/73)
        \centering
        \includegraphics[width=0.8\linewidth]{Chapter_SpDC/Figures/PDF/HardwareSpecs_RWtransactions_1.pdf}
    ...
    \begin{subfigure}[t]{0.441558442\linewidth} %34/77 (34/73)
        \centering
        \includegraphics[width=0.8\linewidth]{Chapter_SpDC/Figures/PDF/HardwareSpecs_RWtransactions_2.pdf}
        \caption{Reduction Cache}
        \label{fig:spdc:red_based_cache}
    \end{subfigure}
    \caption{Read (R) and Write (W) Transactions of a \Gls{reduction} Operation in Generic and \Gls{reduction} Caches \note{(TODO there is place: put legend on the side)}}
    \label{fig:spdc:RWtransactions}
\end{figure}

\begin{highlight}{Definition}{LimeGreen}
    A \textbf{\gls{redC}} is a data-cache containing an \textbf{arithmetic unit} and a dedicated \textbf{support for \gls{reduction} operations}, via single ``fire-and-forget'' \emph{RED} instructions.
\end{highlight}