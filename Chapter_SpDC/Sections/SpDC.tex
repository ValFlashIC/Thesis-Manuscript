...
However, \acrlong{spdc} is designed to extend to multilevel memory hierarchies and multi-core architectures (see Chapter~\ref{cha:optim}), and to adapt to other region configurations.
