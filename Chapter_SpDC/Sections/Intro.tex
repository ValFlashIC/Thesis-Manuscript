...
Finally, we evaluate its performance through \gls{highLevel} modeling on \gls{banded} and non-\gls{banded} matrices, highlighting the influence of data regularity on cache efficiency.