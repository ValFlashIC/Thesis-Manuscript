...
ASA is an accelerator which  optimizes the \gls{gather} aspect of SpGEMM kernel with low area overhead, while leaving high software flexibility. Unlike other \algo{Gust} accelerators, there is no hardware \gls{gather} support for reusing or caching the $B$-rows.