...
\begin{highlight}{Takeaways}{Mulberry}
    ...
    \begin{itemize}
        ...
        \item \textbf{Core operations:} \gls{gather}/\gls{scatter} hardware support
    ...
    \begin{itemize}
        ...
        \item \textbf{Memory Optimization:} Efficient use of local memory, whether through custom caches or smart \gls{eviction} policies, is critical to reducing off-chip traffic and improving performance.
        \item \textbf{Adaptability:} The most successful accelerators dynamically adjust their dataflows and memory strategies to match the sparsity patterns of the input matrices, highlighting the importance of flexibility in hardware design.
        \item \textbf{Scalability and Parallelism:} High-performance designs leverage parallel \gls{reduction} and merger units and optimized memory hierarchies to handle large-scale, irregular workloads efficiently.
    \end{itemize}
