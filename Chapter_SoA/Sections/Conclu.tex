...
\begin{highlight}{Takeaways}{Mulberry}
    ...
    \begin{itemize}
        ...
        \item \textbf{Position in memory hierarchy:} near-processor, near-cache, or near-main memory
    ...
    \begin{itemize}
        ...
        \item \textbf{Memory Optimization:} Efficient use of local memory, whether through custom caches or smart \gls{eviction} policies, is critical to reduce off-chip traffic.
    ...
    Our work focuses on near-cache, \textit{processor-assist} accelerators that computes \gls{scatter}-focused \acrlong{op} \acrshort{spmv} kernels.
\end{highlight}
