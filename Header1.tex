...
\includepdf[pages=-]{Figures/PDF/FrontPage.pdf}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\ThisULCornerWallPaper{1.0}{Figures/PDF/Fond_Page_de_Garde_CEA}
...
\begin{minipage}[t][0.18\headerheight]{\linewidth}
    ...
    \textit{ORCID : 0000-0000-0000-0000}
    
    \textit{professional@address.1}
    
    \textit{professional@address.2}
...
\begin{minipage}[t][0.23\headerheight]{\linewidth}
    ...
    \begin{tabular}{rl}
        Thesis Adviser: & FirstName LASTNAME \\
        Thesis Co-Supervisors: & FirstName LASTNAME \\
        & FirstName LASTNAME \\
        & \\
        CSI Members: & FirstName LASTNAME (HDR) \\
        & FirstName LASTNAME
    \end{tabular}
