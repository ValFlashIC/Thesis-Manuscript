...
\begin{minipage}[t][0.03\headerheight]{\linewidth}
    \normalsize
    \centering
...
\begin{minipage}[t][0.13\headerheight]{\linewidth}
    \normalsize
    \centering

    \begin{tabular}{rl}
        President: & Pr. Roselyne CHOTIN \\
        Rapporteurs: & Pr. Roselyne CHOTIN \\
        & Pr. Olivier SENTIEYS \\
        Jury Members: & Pr. Fr\'ed\'eric ROUSSEAU \\
        & Pr. Roselyne CHOTIN \\
        & Pr. Olivier SENTIEYS \\
        & Pr. Yves ROBERT \\
        & Dr. Benoit DUPONT DE DINECHIN \\
        Guest: & Dr. Adrian EVANS
    \end{tabular}
