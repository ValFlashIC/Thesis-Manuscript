...
The configurations are summarized in Table~\ref{tab:arch:regions}.
...
\begin{figure}[t]
    \begin{minipage}{\linewidth}
        ...
        \begin{minipage}{\linewidth}
            \lstinputlisting[
                title=\textbf{Listing 1:} C Code for the \algo{OP} SpMV with RED Operations
            ]{Chapter_MicroArch/Code/op_spmv_unroll.c}
        \end{minipage}
        %\bigskip
    \end{minipage}
\end{figure}
