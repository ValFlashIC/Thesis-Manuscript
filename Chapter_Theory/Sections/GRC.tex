...
Separating the inputs in a dedicated cache region also has the advantage of allowing prefetching techniques~\cite{Smith1982_Prefetcher} to be used efficiently.
