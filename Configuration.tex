...
% To register algorithms in tocloft package
% \makeatletter
% \begingroup
%   \let\newcounter\@gobble
...
%   \globaldefs\@ne
%   \let\c@loadepth\@ne
%   \newlistof{algorithmes}{loa}{\listalgorithmcfname}
% \endgroup
% \let\l@algorithm\l@algorithmes
% \makeatother

% \cftsetindents{figure}{0em}{3.5em}
% \cftsetindents{table}{0em}{3.5em}
% \cftsetindents{sourcecode}{0em}{3.5em}
% \cftsetindents{algorithmes}{0em}{3.5em}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
