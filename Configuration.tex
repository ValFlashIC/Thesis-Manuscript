...
\def\HeadHeight{12.565pt}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Variables
\renewcommand{\title}{Design of a Memory System for Sparse Data Processing}
\newcommand{\frtitle}{Conception d'un syst\`eme m\'emoire pour traitement de donn\'ees creuses}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Variables
\def\FootpageNote{Universit\'e Grenoble Alpes, CEA, LIST, TIMA}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Personalize Chapter Titles
\newtcolorbox{titlecolorbox}[2]{
	sharp corners,
    ...
    notitle,
    height=#1,
	interior style = {draw=none, fill=none, left color=black!2, right color=black},
    before=\hfill,
	enhanced
}
...
\titleformat{\chapter}[display]
	...
	{0pt}
	{
		...
		\begin{minipage}[b]{0.79\linewidth}
			\vspace*{-1.1em}
			\raggedright\singlespacing\scshape{#1}
		\end{minipage}
		\hfill
		\begin{minipage}[b]{0.19\linewidth}
			\hfill\fontsize{70}{60}\selectfont\thechapter
		\end{minipage}
	}
	[]
...
\usepackage[pdftex,
            ...
            pdfsubject={\title},
            pdfkeywords={Sparse Matrices; Data-Caches; Microarchitecture},
