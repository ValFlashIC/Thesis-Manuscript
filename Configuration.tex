...
\def\TopMargin{0.70cm}
\def\BottomMargin{1.90cm}
\def\LeftMargin{2.50cm}
\def\RightMargin{2.50cm}

\def\HeadHeight{39.0pt}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Variables
\renewcommand{\title}{The Title of your Manuscript}
\newcommand{\frtitle}{Le titre de votre manuscrit}
\renewcommand{\author}{FirstName LASTNAME}
\newcommand{\doctype}{Document Type} % Ex.: Thesis / Rapport de Stage

\newcommand{\sectitle}{Sec. Title} % Don't modify this

\newcommand{\StartYear}{20xx}
\newcommand{\EndYear}{20xx}
\newcommand{\StartDate}{xx.xx.\StartYear}
\newcommand{\EndDate}{xx.xx.\EndYear}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure}[#4]
        \begin{enumerate}[label=, ref=\thechapter.\thesourcecode, topsep=0cm, leftmargin=0cm]
            ...
            \begin{minipage}{\linewidth}
                ...
                \begin{minipage}{\linewidth}
                    \lstinputlisting[
                        title=Source Code \thechapter.\thesourcecode: #2]{#1}
                \end{minipage}
            \end{minipage}
        \end{enumerate}
    \end{figure}
...
\def\FootpageNote{Whatever you want} % Your affiliation for example
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\algo}[1]{{\fontfamily{qcr}\selectfont #1}}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
