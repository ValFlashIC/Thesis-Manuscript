...
\def\TopMargin{0.00cm}
\def\BottomMargin{1.80cm}
...
\newtcolorbox{takeaways}[1]{
	...
	title style={draw=none, fill=none, left color=SkyBlue!10, right color=white},
	coltitle=SkyBlue,
	enhanced,
	colframe=SkyBlue,
	colback=SkyBlue!2,
	borderline west={1mm}{0mm}{SkyBlue},
	title={#1},
	breakable
}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\algo}[1]{{\fontfamily{lmtt}\selectfont#1}}
\def\ldb{[\![}
\def\rdb{]\!]}
\def\acc{\mathit{\,+\!\!=\,}}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
